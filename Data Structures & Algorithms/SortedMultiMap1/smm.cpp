...
vector<TValue> smm::search(TKey c) const {
...
bool smm::remove(TKey c, TValue v) {
...
bool smm::isEmpty() const {

    return length == 0;
}

ValueIterator smm::iterator(TKey k) const {
